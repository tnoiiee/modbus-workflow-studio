...
const overviewStatus=(error:unknown)=>{const code=(error as{code?:string}).code;return code==='REVISION_CONFLICT'?409:code==='LAST_PAGE'?409:code==='DUPLICATE_NAME'||code==='INVALID_NAME'||code==='INVALID_ID'?400:code==='NOT_FOUND'?404:400};
